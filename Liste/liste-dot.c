...
void list_del_reversed(list_t *l){
  printf("del lista reverse\n");
  if (l->head==NULL){
    printf("LISTA VUOTA\n");
  }
  else{
...
void list_print_reversed(list_t *l){
  printf("stampo la lista reverse\n");
  if (l->head==NULL){
    printf("LISTA VUOTA\n");
  }
  else{
    rec_print_node(l->head);
  }
