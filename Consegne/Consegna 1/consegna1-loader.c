...
/*
 Prove divisioni: 
     200: 107,6356,36855.0,214323
     300: 07,6536,25203.9,201910
     400: 107,6735,19335.3,189261
     600: 07,7134,13624.1,139299
     743(max): 107,7420,11914.8,111035 
*/
...
int main(int argc, char **argv) {
  ...
  int* ArraymaggiorediPIVOT; // array contenete elementi maggiori di 200
  ...
  input_data.open("data.txt");
    ...
    ArraymaggiorediPIVOT = new int[max_dim];
	...
	print_array(A,n);
      ...
      int n_minore_PIVOT = ordinamento_minoredi(A,n,ArrayminorediPIVOT,ArraymaggiorediPIVOT,PIVOT);


      int n_maggiore_PIVOT = n-n_minore_PIVOT;

      // merge sort per i numeri maggiori di 200
      merge_sort(ArraymaggiorediPIVOT, n_minore_PIVOT, n-1, L, R );

      // counting sort per i numeri minori di 200
      counting_sort(ArrayminorediPIVOT,B,C,n_minore_PIVOT,PIVOT);
    


      delete [] ArrayminorediPIVOT;
      delete [] ArraymaggiorediPIVOT;
